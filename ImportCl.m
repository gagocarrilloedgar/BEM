function AirfoilData = ImportCl(filename, startRow, endRow)
%IMPORTFILE1 Import numeric data from a text file as a matrix.
%   AIRFOILDATA = IMPORTFILE1(FILENAME) Reads data from text file FILENAME
%   for the default selection.
%
%   AIRFOILDATA = IMPORTFILE1(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   AirfoilData = importfile1('AirfoilData.txt', 8, 72);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2018/10/17 14:50:47
...
formatSpec = '%*s%f%*s%*s%*s%*s%*s%*s%*s%*s%*s%*s%[^\n\r]';
...
AirfoilData = table(dataArray{1:end-1}, 'VariableNames', {'CL'});
